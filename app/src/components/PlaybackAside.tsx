import { ActionIcon, Anchor, Box, Button, Group, Modal, Paper, Radio, Stack, Text, TextInput } from '@mantine/core';
			...
			<Stack h='100%' justify='space-between'>
				<Group align='flex-start' gap='xs' wrap='nowrap'>
					<Paper shadow="sm" p="md" style={{ flex: 1 }}>
						<Stack gap="md">
							...
							<Stack gap="xs">
								...
								<Text size="sm" fw={500}>LENGTH</Text>
								<Text size="sm" c="dimmed">{selectedTrack?.length || ''}</Text>
							</Stack>
						</Stack>
					</Paper>
					...
					<Stack gap='xs'>
						...
						<ActionIcon size='lg' variant='default'><TbDevices size={20} /></ActionIcon>
						<ActionIcon size='lg' variant='default'><TbFile size={20} /></ActionIcon>
						<ActionIcon size='lg' variant='default'><TbCopy size={20} /></ActionIcon>
						<ActionIcon size='lg' variant='default'><TbPlayerTrackNext size={20} /></ActionIcon>
