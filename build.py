...
if __name__ == '__main__':
    ...
    pip_cmd = f'"{sys.executable}" -m pip install -i https://PySimpleGUI.net/install --upgrade {install_to_user} --upgrade-strategy eager -r "{REQUIREMENTS_FILE}" -r "{REQUIREMENTS_DEV_FILE}"'
